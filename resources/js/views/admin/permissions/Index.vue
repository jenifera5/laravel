        ...
        <div class="col-md-12">
            <div class="card border-0">
                <div class="card-header bg-transparent">
                    <h5 class="float-start">Permisos</h5>
                ...
                <div class="card-body shadow-sm">
                    <div class="mb-4">
                        <input v-model="search_global" type="text" placeholder="Buscar..." class="form-control w-25">
                    </div>
                                ...
                                <tr v-for="post in permissions.data" :key="post.id">
                                    ...
                                    <td class="px-6 py-4 text-sm">
                                        <router-link v-if="can('permission-edit')"
                                            ...
                                            class="badge bg-primary" style="width: 70px; text-align: center;">Editar
                                        </router-link>
                                        <a href="#" v-if="can('permission-delete')"
                                            @click.prevent="deletePermission(post.id)" class=" badge bg-danger"
